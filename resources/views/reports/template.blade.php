...
<body>
        ...
        <table class="header-table">
            <tr>
                <td>
                    ...
                    @else
                        <!-- Fallback Text Logo -->
                        <span style="font-size: 22px; font-weight: 900; color: #3b82f6; letter-spacing: -1px;">MainApp</span>
                    @endif
                </td>
                <td class="company-info">
                    <div class="company-name">{{ $tenantName ?? 'MainApp Multi-Tenant' }}</div>
    ...
    <!-- Footer Counter -->
    <div class="footer">
        Generated by MainApp Boilerplate System &mdash; Page <span class="page-number"></span>
    </div>
